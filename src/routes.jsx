...
const OrderForm = lazy(() => import("./Components/Orders/order-form"));
const GuestCart = lazy(() => import("./Components/guestUser/guestCart"));
const CheckoutCancel = lazy(() => import("./Components/guestUser/CancelPage"));
...
const Checkout = lazy(() => import("./Components/guestUser/guestUserCheckout"));
